  ...
  <div class="d-flex" id="wrapper">
    ...
    <div class="bg-light border-right" id="sidebar-wrapper">
      ...
      <div class="list-group list-group-flush">
        <a href="index.php" class="list-group-item list-group-item-action bg-dark text-white">Tipe Data Pada SQL</a>
    ...
    <div id="page-content-wrapper">
      ...
      <div class="container">
        ...
        <p>Untuk nantinya dapat mendefinisikan sebuah tabel pada database SQL dibutuhkan tipe data yang harus ditentukan agar sesuai dengan data yang disimpan pada setiap atribut tabel.</p>
        ...
        <div style="position:relative;padding-top:56.25%;">
          <iframe src="https://www.youtube.com/embed/8swA-PqlEP0" frameborder="0" allowfullscreen style="position:absolute;top:0;left:0;width:100%;height:100%;"></iframe>
        </div>
        <br><br>
        <br><br>
        ...
        <div class="row justify-content-end">
          <a href="page2.php" class="btn btn-primary" role="button" aria-disabled="true">Selanjutnya</a>
        </div>
      </div>
      <br><br>
    </div>
